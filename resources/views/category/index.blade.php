...
@endpush
@section('content')
            <div id="notification" class="notification-delete">
                Loại sản phẩm đã được liên kết không thể xóa
            </div>
            <div class="col-11 mt-5 pl-0 pr-4">
                <div class="row">
                    <div class=" body-content col-6 mt-2 item-h2">
                        <h2 class="font-weight-bolder">Danh sách loại sản phẩm</h2><br>
                    </div>
                    <div class="col-6 text-right">
                        <a href="{{route('addcategory')}}" class="btn">
                            <button class="button-add-product">Thêm Loại sản phẩm</button>
                        </a>
                    </div>
                </div>
                <p><a href="{{route('product')}}">Quản lý sản phẩm</a></p>
                <div class="gridtable mt-4">
                    <table class="table table-bordered table-fixed" style="border-radius: 20px;">
                        <thead class="text-muted text-center">
                            <tr>
                                <th class="font-weight-bolder p-3 pb-4 h5">Loại sản phẩm</th>
                                <th class="font-weight-bolder p-3 pb-4 h5">Tình trạng</th>
                                <th class="font-weight-bolder p-3 pb-4 h5">ID loại sản phẩm</th>
                                <th class="font-weight-bolder p-3 pb-4 h5">Thao tác</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($data as $item)
                                <tr id="id-category-{{$item->id}}">
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="row">
                                            <div class="col">
                                                <a href="{{route('get-category',['id'=>$item->id])}}">
...
@endsection
@push('scripts')
    <script type="module" src="assets/js/manage-category.js"></script>
