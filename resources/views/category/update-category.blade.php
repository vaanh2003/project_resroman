...
<div class="col-10 mt-5 pr-0">
    <div class="row">
        ...
        <div class="col-12 rounded border p-4">
            ...
            <form class="item-form-all" method="POST" action="{{ route('update-category') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$data->id}}">
                <div class="form-row item-form-add">
                    <div class="form-group col px-3">
                        <label class="h7">Tên loại sản phẩm:</label>
                        <input type="text" name="name" class="form-control" placeholder="Nhập tên" required value="{{$data->name}}">
                    </div>
                    <div class="form-group col px-3">
